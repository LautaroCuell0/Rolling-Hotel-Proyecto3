...
function DetalleHab(){
   const urlBase = `http://localhost:4000/api/reservas`;
   ...
   useEffect(() => {
      const fetchHabitacionData = async () => {
        try {
          ...
          const habitacionEncontrada = data.habitaciones.filter((item )=>item._id===habitacion.idHabitacion)
     ...
     return(
        ...
        <div className="container-detalles">
            <div className="img-reservacion"><img src={habitacionData?habitacionData.imagen1:''} alt="" /></div>
           ...
           />  
               ...
               <div className="button-reservacion" onClick={handleReserva}><button>RESERVAR</button></div>
            </div>
        </div>
        </>
     )
